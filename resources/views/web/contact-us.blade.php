    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 gap-4">
            <div class="col-span-2 sm:col-span-1">
                ...
                <div class="mt-6">
                    <a href="tel:+19542128520" class="flex items-center space-x-3 hover:text-indigo-600 transition-all">
                    ...
                    <a href="mailto:info@christcomchurch.org" class="mt-6 flex items-center space-x-3 hover:text-indigo-600 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <a href="https://goo.gl/maps/DiZtYw2SrgPY9PEp9" class="mt-6 flex items-top space-x-3 hover:text-indigo-600 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
