<div>
    <button wire:click="$toggle('modal')" class="mt-1 font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</button>
    ...
    <x-jet-dialog-modal wire:model="modal">
        ...
        <x-slot name="content">
            ...
            <div class="mt-6">
                <label for="is_enabled" class="flex items-center space-x-2">
                    <x-jet-input id="is_enabled" type="checkbox" wire:model="is_enabled"/>
                    <span>Enable the slide</span>
                </label>
            </div>
