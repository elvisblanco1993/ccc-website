    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="">
            ...
            <div class="mt-4">
                ...
                <p>Christ Community Church exists to worship God, fellowship in community and build the body of Christ by making, maturing and multiplying  disciples until the Lord Jesus Christ returns (<a target="_blank" class="underline hover:text-ccc" href="https://www.biblegateway.com/passage/?search=Acts+2%3A42-47&version=ESV">Acts 2:42-47</a>, <a target="_blank" class="underline hover:text-ccc" href="https://www.biblegateway.com/passage/?search=Mt.+28%3A18-20&version=ESV">Mt. 28:18-20</a>, <a target="_blank" class="underline hover:text-ccc" href="https://www.biblegateway.com/passage/?search=Eph.+4%3A11-16&version=ESV">Eph. 4:11-16</a>).</p>
            </div>
        ...
        <div class="mt-12">
            ...
            <div class="mt-6 grid grid-cols-3 gap-8">
                <div class="block md:hidden col-span-3 sm:col-span-1">
                ...
                <div class="hidden md:block col-span-3 sm:col-span-1">
                    <img src="{{ asset('Pastor_Bernie.jpg') }}" alt="" class="rounded-lg shadow-lg">
                    <h4 class="mt-4 text-lg font-bold">Bernie Diaz</h4>
                    <p class="text-slate-700">Pastor, Elder</p>
                    <a class="underline text-ccc text-sm" href="mailto:info@christcomchurch.org">info@christcomchurch.org</a>
