...
@section('content')
    <header class="py-12 overflow-hidden">
        <div class="bg-gradient-to-tr from-slate-100 to-indigo-50 max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 rounded-xl">
            ...
            <div class="mt-6 grid grid-cols-3 gap-4 items-center text-center">
                <div class="col-span-3 sm:col-span-1">
                    <a href="https://www.biblegateway.com/resources/audio/" target="_blank" class="inline-flex items-center space-x-3 hover:text-indigo-600">
                ...
                <div class="col-span-3 sm:col-span-1">
                    <a href="https://www.ligonier.org/blog/get-basic-overview-bible/" target="_blank" class="inline-flex items-center space-x-3 hover:text-indigo-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="h-8 w-8" viewBox="0 0 16 16">
    ...
    @if ($plan)
        <section class="max-w-7xl mx-auto p-4 sm:p-0">
            <object data="{{ asset($plan->url) }}" type="" class="w-full" height="1200"></object>
        </section>
    @endif
@endsection
