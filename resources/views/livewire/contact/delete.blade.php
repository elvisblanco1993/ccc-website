<div>
    ...
    <x-jet-confirmation-modal wire:model="modal">
        <x-slot name="title">{{ __("Are you sure you want to delete this inquiry?") }}</x-slot>
        <x-slot name="content">
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button class="ml-3" wire:click="delete">{{ __("Delete inquiry") }}</x-jet-danger-button>
        </x-slot>
