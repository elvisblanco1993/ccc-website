        ...
        <div class="bg-gradient-to-tr from-slate-100 to-indigo-50 max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 md:rounded-xl">
            ...
            <div class="mt-6 grid grid-cols-3 gap-4 items-center md:text-center">
                <div class="col-span-3 sm:col-span-1">
                    <a href="https://www.biblegateway.com/resources/audio/" target="_blank" class="inline-flex items-start items-center space-x-3 hover:text-indigo-600">
                ...
                <div class="col-span-3 sm:col-span-1">
                    <a href="https://www.ligonier.org/blog/get-basic-overview-bible/" target="_blank" class="inline-flex items-start items-center space-x-3 hover:text-indigo-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="h-8 w-8" viewBox="0 0 16 16">
